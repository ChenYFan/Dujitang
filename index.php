...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	...
	<meta property="og:image" content="index/icon.png">
	...
	<link rel="icon" href="index/favicon.ico" type="image/x-icon" id="page_favionc">
	<link href="index/min.css" rel="stylesheet">
	<link rel="alternate icon" type="image/png" href="index/icon.png">
	...
	<div class="row" style="margin-top: 30px;">
	    ...
	    <div class="col">
	    	<div class="float-right" style="padding-top: 0px;">
	    		<a class="btn btn-primary btn-filled btn-xs" href="https://github.com/ChenYFan/Dujitang">简化版</a>
	    	</div>
			<div class="float-right" style="padding-top: 0px;">
	    		<a class="btn btn-primary btn-filled btn-xs" href="https://github.com/egotong/nows">原始</a>
	    	</div>
	    </div>
		</div>
</div>
...
<div class="container main-sentence justify-content-center text-center">
						...
						<span id="sentence" style="font-size: 2rem;"><script src="api.php"></script></span>
...
<div class="foot-1" style="position: absolute; bottom: 7vh;width: 100%;">
	...
	<div class="container">
		<div class="row">
			...
			<p class="lead text">我们并不是恶意假冒www.nowsfun.com,我们只是对其代码进行了优化,脱离了数据库而单独存在,请认准官方站点www.nowsfun.com</p>
